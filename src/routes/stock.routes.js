...
const { createStockEntry, getStockEntries, updateStockEntry, deleteStockEntry, transferStock } = require('../controllers/stock.controller');
...
router.post('/transfer', authenticate, blockPermanentSecretary, requireSuperAdminOrInspector, transferStock);
